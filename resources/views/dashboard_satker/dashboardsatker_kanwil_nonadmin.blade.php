...
@push('myscript')
    ...
    <script>
        ...
        //console.log("testing: "+realisasi_publikasi_total);
        ...
        //console.log("tested : "+realisasi_publikasi_total_linkmedia);
    ...
    <script>
        ...
        function fungsi_angka(val, key) {
            //console.log("valuenya broyy:" + val);
        ...
        function fungsi_linkmedia(val, key){
            //console.log("valuenya media broyy ya : " + val);
        ...
        const myChart_linkmedia = new Chart(ctx_linkmedia, {
            ...
            data :{
                ...
                datasets:[{
                    label: 'Jumlah Kontribusi Link Media Lokal (Humas Kanwil)',
    ...
    <script>
        ...
        //console.log("realisasi_harmonisasi_total ANGKA BROY:"+realisasi_publikasi_kanwil_total_angka);

        const total_kanwil = <?php echo json_encode($total_kanwil); ?>;
        //console.log("totalcuk : " + total_kanwil);

        const total_kanwil_angka = <?php echo json_encode($total_kanwil_angka); ?>;
        //console.log("TOTAL KANWIL ANGKA BROY : " + total_kanwil_angka);
    ...
    <script>
        ...
        //console.log("zona_publikasi_list_kanwil: "+zona_publikasi_list_kanwil);

        var zona_publikasi_list_kanwil_angka = <?php echo json_encode($zona_publikasi_list_ii_kanwil_angka);  ?>;
        //console.log("zona_publikasi_list_kanwil, angka broy : "+zona_publikasi_list_kanwil_angka);
        ...
        //console.log("nama zona publikasi kanwil : "+ nama_zona_publikasi_kanwil);
        ...
        const myChart_Kanwil_angka = new Chart(ctx_kanwil_angka, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: persen_realisasi_kanwil_angka,
                    backgroundColor: 'rgba(54, 162, 235, 0.2)',
                    borderColor: 'rgba(54, 162, 235, 1)',
                    borderWidth: 1
                }],
