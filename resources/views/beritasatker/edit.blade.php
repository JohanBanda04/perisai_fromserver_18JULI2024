                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-input-dinamis col-8" style="overflow: auto">
                                            ...
                                            <input type="text" value="{{ $link }}" id="jumlah_edit[]"
                                                   name="jumlah_edit[]"
                                                   class="jumlah_medlok_edit form-control border-grey"
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <select required name="kode_media_nasional[]" id="kode_media_nasional[]"
                                                    class="form-select">
                                                <option value="">-Nama Media-</option>
                                                @if($kode_media_nasional=="no media")
                                                    <option selected value="no media">-No Media-</option>
                                                    @foreach($getmedia as $idx=>$media)
                                                    ...
                                                    @endforeach
                                                @elseif($kode_media_nasional!="no media")
                                                    <option value="no media">-No Media-</option>
                                                    @foreach($getmedia as $idx=>$media)
                                                        <option {{ $kode_media_nasional==$media->kode_media?"selected":"" }} value="{{ $media->kode_media }}">
                                                            {{ $media->name }}
                                        ...
                                        <div class="col-input-dinamis col-lg-8" style="overflow: auto">
                                            ...
                                            <input type="text" value="{{ $link_nasional }}"
                                                   ...
                                                   class="jumlah_mednas_edit form-control border-grey"
...
<script type="text/javascript">
    ...
    function addFileMednas($row_id_berita) {
        ...
        var html4 = '<div class="form-group input-dinamis m-20 mt-2" id="' + divIdMednas + '">' +
            ...
            '<input type="text" name="jumlah_edit_nasional[]" id="jumlah_edit_nasional[]" ' +
            'class="jumlah_mednas_edit form-control border-grey" ' +
    ...
    function addFileMedlok($row_id_berita) {
        ...
        var html4 = '<div class="form-group input-dinamis m-20 mt-2" id="' + divIdMedlok + '">' +
            ...
            '<input type="text" name="jumlah_edit[]" id="jumlah_edit[]" class="jumlah_medlok_edit form-control border-grey" ' +
...
<script>
    $(function () {
        ...
        $('#frmSatkerBeritaEdit').submit(function () {
            ...
            var jumlah_medlok_edit = document.getElementsByClassName('jumlah_medlok_edit');
            //alert(jumlah_medlok_edit.length);
            //return false;
            for (var i = 0; i < jumlah_medlok_edit.length; i++) {
                keywordsArr = jumlah_medlok_edit[i].value.split('|||');
                if (keywordsArr.length < 2) {
                    Swal.fire({
                        ...
                        $('#jumlah_edit[' + i + ']').focus();
                        jumlah_medlok_edit[i].style.backgroundColor = "#f00";
                    });
                    return false;
                } else if (keywordsArr.length == 2) {
                    jumlah_medlok_edit[i].style.backgroundColor = "";
                    if (keywordsArr[1] == "") {
                        Swal.fire({
                            title: 'Warning!',
                            text: 'Link Media Lokal Belum Terisi Lengkap',
            ...
            var jumlah_mednas_edit = document.getElementsByClassName('jumlah_mednas_edit');
            for (var k = 0; k < jumlah_mednas_edit.length; k++) {
                keywordsArr_nasional = jumlah_mednas_edit[k].value.split("|||");
                if (keywordsArr_nasional.length < 2) {
                    Swal.fire({
                        ...
                        $('#jumlah_edit_nasional[' + k + ']').focus();
                        jumlah_mednas_edit[k].style.backgroundColor = "#f00";
                    });
                    return false;
                } else if (keywordsArr_nasional.length == 2) {
                    jumlah_mednas_edit[k].style.backgroundColor = "";
